...
public class Search {
  ...
  /**
   * This method handles the actual calling of search depending on the data passed in. There are
   * three different search implementations depending on user specifications, so this decides which
   * to call
   *
   * @param target
   * @param columnSpec
